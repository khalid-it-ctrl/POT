...
const users = {
  ...
  "mohamed.re@pot": {
    ...
    tasks: [
      ...
      { name: "Meeting", grade: 2 },
      { name: "Meeting", grade: 5 },
      { name: "Project Presentational ", grade: 10 },
      { name: "Meeting", grade: 5 },
      { name: "Meeting", grade: 20 },
    ],
    reports: [
...
`;
  ...
  <h2>Meeting for you !!</h2>
  <table>
    <tr><th>Meeting</th><th>Presence</th></tr>
...
`;
  ...
  <div class="chart">
    ...
    `<div class="bar" style="height:${i.grade * 10}px">${i.grade}</div>`).join('')}
  </div>
`;
}
